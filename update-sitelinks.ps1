...
foreach ($page in $pages) {
    ...
    if ($accidentSectionMatch.Success) {
        ...
        $ctaMarker = '<div style="text-align: center; margin-top: 32px;">'
        $section = [regex]::Replace($section, '(?s)<div class="accident-grid">.*?</div>\s*<div style="text-align: center; margin-top: 32px;">', "$grid`r`n            $ctaMarker", 1)
    ...
    if ($caseSectionMatch.Success) {
        ...
        $caseMarker = '<div style="background:'
        $section = [regex]::Replace($section, '(?s)<div style="display: grid;.*?</div>\s*<div style="background:', "$grid`r`n                $caseMarker", 1)
    ...
    if ($trustSectionMatch.Success) {
        ...
        $trustMarker = '<div style="text-align: center; margin-top: 48px;">'
        $section = [regex]::Replace($section, '(?s)<div class="trust-grid">.*?</div>\s*<div style="text-align: center; margin-top: 48px;">', "$grid`r`n            $trustMarker", 1)
    ...
    if ($processSectionMatch.Success) {
        ...
        $processMarker = '<div style="text-align: center; margin-top: 48px;">'
        $section = [regex]::Replace($section, '(?s)<div class="process-steps">.*?</div>\s*<div style="text-align: center; margin-top: 48px;">', "$steps`r`n            $processMarker", 1)
